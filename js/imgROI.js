  jQuery(function($){
	...
	defaultURN = "urn:cite:epifacs:epifacsimg.DSC01125";
	paramURN = get("urn");
	...
	var imgSvcURL = "http://services.perseus.tufts.edu/sparqlimg/api?";
	var detailWidth = "9000";
	var mainViewWidth = 1000 / widthFactor;
    ...
    function updatePreview(c)
    {
      if (parseInt(c.w) > 0)
      {
		...
		function updateData(t,l,w,h){
			...
			newURN = imgURN + "@" + t + "," + l + "," + w + "," + h; 
			thisPage = "index.html?urn=" + newURN;
